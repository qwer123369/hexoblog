...
{% asset_img ex_5.png [PHP Curly Syntax] %}
...
{% asset_img ex_7.png [php://input方法] %}
...
{% asset_img ex_8.png [preg_replace方法] %}
...
{% asset_img ex_16.png [免杀] %}

再试试其他免杀工具。

WebShellKiller：

{% asset_img ex_17.png [WebShellKiller] %}

安全狗：

{% asset_img ex_18.png [安全狗] %}

微步云沙箱：

{% asset_img ex_19.png [微步云沙箱] %}

再试试可不可以连接没有问题，完美！！

{% asset_img ex_20.png [菜刀] %}
